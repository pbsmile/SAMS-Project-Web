            ...
            <div className="overlay-container">
                <div className="overlay">
                    <div className="overlay-panel overlay-left">
                        ...
                        <button className="ghost" id="signIn"onClick={() => setState({ container: 'right-panel-active' })} >Sign In</button>
                    </div>
                    <div className="overlay-panel overlay-right">
                        <h1>Hello, Friend!</h1>
                        <p>Enter your personal details and start journey with us</p>
                        <button className="ghost" id="signUp" onClick={() => setState({ container: 'right-panel-active' })}>Sign Up</button>
                    </div>
                </div>
            </div>
        </div>
